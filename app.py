...
def detect_emotion():
    ...
    if capture_button:
        ...
        # Show the captured image on the website
        st.image(temp_image_path, caption="Captured Image", use_column_width=True)
        ...
        try:
            ...
            # Open YouTube with recommended songs
            if "language" in st.session_state and "singer" in st.session_state:
                query = f"{st.session_state.language} {emotion} song {st.session_state.singer}"
...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        if choice == "Register":
            ...
            language = st.text_input("Preferred Music Language (e.g., English, Hindi)")
